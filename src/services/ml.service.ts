...
import { IMLSearchResult, IMLArticle, IMLSeller, IMLCategory } from '../interfaces';
import {
...
export class MLService {
  ...
  public static getSeller (id: number) {
    return instance.get(`/users/${id}`).then((res: AxiosResponse<IMLSeller>) => res.data);
  }
